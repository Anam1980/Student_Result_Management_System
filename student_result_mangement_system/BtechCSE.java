...
public class BtechCSE extends javax.swing.JFrame {
    ...
    String course=null;
    String branch=null;
    public BtechCSE(String rollno, String course, String branch) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Btech[CSE]", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 12), new java.awt.Color(0, 102, 102))); // NOI18N
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 312, 88, -1));
        ...
        jPanel1.add(back, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 440, -1, 30));
        ...
        jPanel1.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 440, -1, 30));
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        try{
            ...
            if(rs.next()){
                ...
                st.executeUpdate("insert into BtechCse(rollno ,course ,branch , corejava , os , dbms , networking , computergraphics ) values('"+rollno+"', '"+course+"', '"+branch+"', '"+corejava+"', '"+os+"','"+dbms+"', '"+networking+"', '"+computergraphics+"')");
                JOptionPane.showMessageDialog(null, "Result Upadated successfully");

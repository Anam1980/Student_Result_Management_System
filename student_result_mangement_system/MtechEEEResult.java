 ...
 * @author LENOVO
 */
public class MtechEEEResult extends javax.swing.JFrame {

    /**
     * Creates new form MtechEEEResult
     */
    public MtechEEEResult() {
        initComponents();
    }
    public MtechEEEResult(String rollno) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 66, 53, -1));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 6, 680, 149));
        ...
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(225, 735, 240, 50));
        ...
        getContentPane().add(back, new org.netbeans.lib.awtextra.AbsoluteConstraints(589, 735, 97, 41));
        ...
        jLabel5.setText("Electronic Devices");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(7, 71, -1, -1));

        jLabel6.setFont(new java.awt.Font("Segoe UI Semibold", 1, 14)); // NOI18N
        jLabel6.setText("Power Electronic");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(7, 208, 119, -1));

        jLabel10.setFont(new java.awt.Font("Segoe UI Semibold", 1, 14)); // NOI18N
        jLabel10.setText("Cyber Security");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(7, 140, -1, -1));

        jLabel11.setFont(new java.awt.Font("Segoe UI Semibold", 1, 14)); // NOI18N
        jLabel11.setText("Special Electric Machine");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(7, 277, 186, -1));
        ...
        jPanel1.add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(237, 74, 43, -1));

        jLabel28.setText("40");
        jPanel1.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(385, 74, 43, -1));

        jLabel29.setText("100");
        jPanel1.add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(237, 143, 43, -1));

        jLabel30.setText("40");
        jPanel1.add(jLabel30, new org.netbeans.lib.awtextra.AbsoluteConstraints(385, 143, 43, -1));

        jLabel31.setText("100");
        jPanel1.add(jLabel31, new org.netbeans.lib.awtextra.AbsoluteConstraints(237, 280, 43, -1));

        jLabel32.setText("40");
        jPanel1.add(jLabel32, new org.netbeans.lib.awtextra.AbsoluteConstraints(385, 280, 43, -1));

        jLabel33.setText("100");
        jPanel1.add(jLabel33, new org.netbeans.lib.awtextra.AbsoluteConstraints(237, 211, 43, -1));

        jLabel34.setText("40");
        jPanel1.add(jLabel34, new org.netbeans.lib.awtextra.AbsoluteConstraints(385, 211, 43, -1));

        jTextField13.setEditable(false);
        jTextField13.setFont(new java.awt.Font("Segoe UI Black", 0, 12)); // NOI18N
        jPanel1.add(jTextField13, new org.netbeans.lib.awtextra.AbsoluteConstraints(561, 71, 77, -1));

        jTextField14.setEditable(false);
        jTextField14.setFont(new java.awt.Font("Segoe UI Black", 0, 12)); // NOI18N
        jPanel1.add(jTextField14, new org.netbeans.lib.awtextra.AbsoluteConstraints(561, 140, 77, -1));

        jTextField15.setEditable(false);
        jTextField15.setFont(new java.awt.Font("Segoe UI Black", 0, 12)); // NOI18N
        jPanel1.add(jTextField15, new org.netbeans.lib.awtextra.AbsoluteConstraints(561, 277, 77, -1));

        jTextField16.setEditable(false);
        jTextField16.setFont(new java.awt.Font("Segoe UI Black", 0, 12)); // NOI18N
        jPanel1.add(jTextField16, new org.netbeans.lib.awtextra.AbsoluteConstraints(561, 199, 77, -1));

        jTextField7.setEditable(false);
        jTextField7.setBackground(new java.awt.Color(255, 255, 255));
        jTextField7.setFont(new java.awt.Font("Segoe UI Black", 1, 12)); // NOI18N
        jPanel1.add(jTextField7, new org.netbeans.lib.awtextra.AbsoluteConstraints(575, 432, 77, -1));
        ...
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(266, 435, 43, -1));

        jLabel15.setFont(new java.awt.Font("Segoe UI Semibold", 0, 12)); // NOI18N
        jLabel15.setText("200");
        jPanel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(394, 435, 43, -1));
        ...
        jPanel1.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(29, 18, 97, -1));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 173, 680, 550));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("select * from student inner join MtechEEE where student.rollno='"+rollno+"' and MtechEEE.rollno='"+rollno+"'");
            ...
            if(rs.next()){
                ...
                int s3=Integer.parseInt(jTextField16.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MtechEEEResult.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MtechEEEResult().setVisible(true);
            }
        });
    }

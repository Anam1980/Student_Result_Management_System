 ...
 * @author LENOVO
 */
public class MtechCSE extends javax.swing.JFrame {

    /**
     * Creates new form MtechCSE
     */
    public MtechCSE() {
        initComponents();
    }
    ...
    String course=null;
    String branch=null;
    public MtechCSE(String rollno, String course, String branch) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Mtech[CSE]", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 12), new java.awt.Color(0, 102, 102))); // NOI18N
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel2.setFont(new java.awt.Font("Segoe UI Semibold", 0, 12)); // NOI18N
        jLabel2.setText("Pattern Recognition");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 126, 120, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI Semibold", 0, 12)); // NOI18N
        jLabel3.setText("Soft Computing");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 250, -1, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI Semibold", 0, 12)); // NOI18N
        jLabel4.setText("Compiler Design");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 188, 106, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI Semibold", 0, 12)); // NOI18N
        jLabel5.setText("Mobile Computing");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 312, 120, -1));
        ...
        jPanel1.add(back, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 420, -1, 30));
        ...
        jPanel1.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 420, -1, 30));
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        try{
            ...
            if(rs.next()){
                st.executeUpdate("insert into MtechCSE(rollno , course , branch , patternrecog, compilerdesign, softcomputing, mobilecomputing) values('"+rollno+"', '"+course+"', '"+branch+"', '"+pr+"', '"+cd+"', '"+sc+"', '"+mc+"')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MtechCSE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

 ...
 * @author LENOVO
 */
public class BtechEEE extends javax.swing.JFrame {

    /**
     * Creates new form BtechEEE
     */
    public BtechEEE() {
        initComponents();
    }
    ...
    String course=null;
    String branch=null;
    public BtechEEE(String rollno, String course, String branch) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Btech[EEE]", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 12), new java.awt.Color(0, 102, 102))); // NOI18N
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel2.setFont(new java.awt.Font("Segoe UI Semibold", 0, 12)); // NOI18N
        jLabel2.setText("Power System");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 126, 79, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI Semibold", 0, 12)); // NOI18N
        jLabel3.setText("Circuit & System");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 250, -1, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI Semibold", 0, 12)); // NOI18N
        jLabel4.setText("Microcontroller");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 188, 106, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI Semibold", 0, 12)); // NOI18N
        jLabel5.setText("Analog Electronic");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 312, 100, -1));

        jLabel6.setFont(new java.awt.Font("Segoe UI Semibold", 0, 12)); // NOI18N
        jLabel6.setText("Energy Resources");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 374, 117, -1));
        ...
        jPanel1.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 371, 71, -1));
        ...
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(288, 374, 37, -1));
        ...
        jPanel1.add(back, new org.netbeans.lib.awtextra.AbsoluteConstraints(232, 440, 80, 30));
        ...
        jPanel1.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 440, 80, 30));
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        String ae=jTextField4.getText();
        String er=jTextField5.getText();
        ...
        try{
            ...
            if(rs.next()){
                st.executeUpdate("insert into BtechEEE(rollno , course , branch , powersystem, microcontroller, cktsystem, analogelectronic, energyresources) values('"+rollno+"', '"+course+"', '"+branch+"', '"+ps+"', '"+mc+"', '"+cs+"', '"+ae+"', '"+er+"')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BtechEEE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
